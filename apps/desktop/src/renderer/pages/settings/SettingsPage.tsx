...
function DisplaySettings(): React.JSX.Element {
  ...
  <SettingCard title="图库目录"><Container><Input aria-label="图库目录" readOnly value={presentation?.imageFolder ?? ''}/><Button onClick={() => void chooseFolder()}>浏览</Button></Container></SettingCard>
