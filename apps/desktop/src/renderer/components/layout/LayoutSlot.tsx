...
export type LayoutSlotVariant =
  ...
  | 'character-page-layout' | 'character-workspace' | 'character-summary' | 'character-overview' | 'character-overview-block' | 'character-section-header' | 'character-binding-list' | 'character-binding-item' | 'character-binding-actions' | 'character-danger'
