...
public static class ProtocolConstants
{
    ...
    [
        "system.health", "system.window.fit_virtual_desktop", "system.window.map_client_rect", "system.shutdown", "system.cancel", "system.stream", "settings.get", "settings.save", "chat.history", "chat.send", "chat.update_metadata", "tts.speak",
