...
public static class ProtocolConstants
{
    ...
    [
        "system.health", "system.window.fit_virtual_desktop", "system.shutdown", "system.cancel", "system.stream", "settings.get", "settings.save", "chat.history", "chat.send", "chat.update_metadata", "tts.speak",
        ...
        "pet.voice_menu.get", "pet.voice_intimacy.cycle", "music.current", "music.search_and_play", "music.stop", "status.resources", "status.network", "status.role", "status.tts", "status.llm_latencies", "status.server.health", "status.server.summary", "status.codex_quota", "tts.playback.set",
